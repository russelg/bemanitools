...
#define SDVXHOOK_CONFIG_LEDS_DEFAULT_LEFT_WING_AVG_R_PIN_VALUE (WING_LEFT_UP_R)
#define SDVXHOOK_CONFIG_LEDS_DEFAULT_LEFT_WING_AVG_G_PIN_VALUE (WING_LEFT_UP_G)
#define SDVXHOOK_CONFIG_LEDS_DEFAULT_LEFT_WING_AVG_B_PIN_VALUE (WING_LEFT_UP_B)
...
#define SDVXHOOK_CONFIG_LEDS_DEFAULT_CONTROL_PANEL_AVG_R_PIN_VALUE (CONTROLLER_R)
#define SDVXHOOK_CONFIG_LEDS_DEFAULT_CONTROL_PANEL_AVG_G_PIN_VALUE (CONTROLLER_G)
#define SDVXHOOK_CONFIG_LEDS_DEFAULT_CONTROL_PANEL_AVG_B_PIN_VALUE (CONTROLLER_B)
#define SDVXHOOK_CONFIG_LEDS_DEFAULT_WOOFER_AVG_R_PIN_VALUE (WOOFER_R)
#define SDVXHOOK_CONFIG_LEDS_DEFAULT_WOOFER_AVG_G_PIN_VALUE (WOOFER_G)
#define SDVXHOOK_CONFIG_LEDS_DEFAULT_WOOFER_AVG_B_PIN_VALUE (WOOFER_B)
#define SDVXHOOK_CONFIG_LEDS_DEFAULT_V_UNIT_AVG_R_PIN_VALUE (WING_LEFT_LOW_R)
#define SDVXHOOK_CONFIG_LEDS_DEFAULT_V_UNIT_AVG_G_PIN_VALUE (WING_LEFT_LOW_G)
#define SDVXHOOK_CONFIG_LEDS_DEFAULT_V_UNIT_AVG_B_PIN_VALUE (WING_LEFT_LOW_B)
